...
const HomeBanner = () => {
  return (
    <motion.div
      ...
      animate={{
        backgroundColor: ["#9c27b0", "#ffeb3b", "#8bc34a", "#4caf50", "#009688", "#00bcd4", "#03a9f4", "#3f51b5"],
      ...
      <div className="mx-auto px-8 py-12 flex flex-col gap-2 md:flex-row items-center justify-evenly">
        ...
        >
          <motion.h1
            ...
            animate={{ y: [-10, 0], transition: { duration: 0.5, ease: "easeOut" } }}
          >
            Summer Extravaganza
          </motion.h1>
          <motion.p
        ...
        <motion.div
          ...
          animate={{ scale: [0.95, 1], transition: { duration: 0.4, ease: "easeInOut" } }}
        >
          <Image src="/banner/pngwing.png" alt="Banner Image" className="object-contain" quality={100} fill />
        </motion.div>
      </div>
    </motion.div>
  );
