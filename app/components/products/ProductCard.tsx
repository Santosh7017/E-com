...
//     className="col-spa-1 cursor-pointer border-[1.2px] border-slate-200
//     bg-slate-50
//     p-2
//     transition
//     hover:scale-105
...
//            <p className="text-2xl uppercase text-gray-900 font-bold">{truncateText(data.name)}</p>
...
//             className="w-52 h-full object-contain rounded-xl" alt={data.name}/>
//             </div>
...
//              <p className="font-bold text-xl">{formatPrice(data.price)}</p>
